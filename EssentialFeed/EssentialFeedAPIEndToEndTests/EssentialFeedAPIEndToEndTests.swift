...
class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchesFixedTestAccountData() {
        ...
        case let .success(items):
            XCTAssertEqual(items.count, 8, "Expect to get 8 items in the test account feed")
        ...
        case let .failure(error):
            XCTFail("Expect to succeed, got \(error) instead")

        default:
            XCTFail("Expect to succeed, got nil instead")
        }
